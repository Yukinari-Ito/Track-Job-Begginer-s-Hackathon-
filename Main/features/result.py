...
def diagnosis_sentences(diagnosis_type):
    if diagnosis_type == "BCS":
        ...
        <h5>◆ ひとこと診断：</h5>
        <p>　「あなたにとって笑いとは、“逃避”ではなく“思考”であり、“破壊”であり、</p>
        <p>　“再構築”です。他人が笑い終えたあとに、ひとりで考え続けているような人。」</p>
